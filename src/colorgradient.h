...
public:
    ...
    */
    enum NanHandling
    {
        nhNone ///< NaN data points are not explicitly handled and shouldn't occur in the data (this
               ///< gives slight performance improvement)
        ,
        nhLowestColor ///< NaN data points appear as the lowest color defined in this
                      ///< QCPColorGradient
        ,
        nhHighestColor ///< NaN data points appear as the highest color defined in this
                       ///< QCPColorGradient
        ,
