...
/*! \class QCPItemBracket
  ...
  \image html QCPItemBracket.png "Bracket example. Blue dotted circles are anchors, solid blue discs
  are positions."
                                  ...
                                  [[maybe_unused]] QVariant* details) const
{
    ...
    switch (mStyle)
    {
        ...
        case QCPItemBracket::bsRound:
        {
            ...
            double b
                = p.distanceSquaredToLine(centerVec - widthVec + lengthVec, centerVec - widthVec);
            double c
                = p.distanceSquaredToLine(centerVec + widthVec + lengthVec, centerVec + widthVec);
