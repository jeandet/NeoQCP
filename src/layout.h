...
public:
    ...
    */
    ...
    /*!
      ...
      margins (e.g. in the case of a QCPAxisRect the axis labels), whereas the inner rect (\ref
      rect) does not.
    ...
    */
    enum SizeConstraintRect
    {
        ...
        ,
        scrOuterRect ///< Minimum/Maximum size constraints apply to outer rect, thus include layout
                     ///< element margins
    };
